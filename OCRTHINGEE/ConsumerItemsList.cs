...
namespace OCRTHINGEE
{
    ...
    internal class ConsumerItemsList
    {
        private readonly string[] _items =
        {
            ...
            "HEL-STATIC FURNACES", "MINERAL EXTRACTORS", "CROP HARVESTERS", "MARINE EQUIPMENT", "PERFORMANCE ENHANCERS",
            ...
            "BERYLLIUM", "GALLIUM", "COLTAN", "RUTILE", "LEPIDOLITE", "INDITE", "GALLITE", "BAUXITE",
